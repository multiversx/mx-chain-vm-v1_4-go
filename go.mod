...
require (
	...
	github.com/multiversx/mx-chain-scenario-go v1.7.1-0.20260507135126-bfdd8f607a1b
	github.com/multiversx/mx-chain-storage-go v1.1.1-0.20260507131742-5e2f95a86f39
